...
public class _03_Pirates_01 {
    public static void main(String[] args) {
        ...
        while (!inputCommand.equals("Sail")){

              String city = inputCommand.split("\\|\\|")[0];
              int population = Integer.parseInt(inputCommand.split("\\|\\|")[1]);
              int gold = Integer.parseInt(inputCommand.split("\\|\\|")[2]);
